...
import { User, Mail, Lock, Eye, EyeOff, Building2, TrendingUp } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 px-4 rounded-lg hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium"
            >
